...
(https://www.dsprelated.com/showcode/41.php). The same sound should be repeated five times:

   - after 0.05 seconds, with attenuation 1
   - after 0.1 seconds, with attenuation 0.9
   - after 0.14 seconds, with attenuation 0.75
   - after 0.4 seconds, with attenuation 0.4
   - after 0.6 seconds, with attenuation 0.2
