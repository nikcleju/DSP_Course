...
Repeat the steps in exercise 1, to design a band-pass elliptic filter of order 4, IIR, with pass-band between 0.25 and 0.3 (or 2500 Hz to 3000 Hz for a sampling frequency of 5000Hz ), transition bands of width 0.02, a passband ripple of 0.5 dB and a minimum stop-band attenuation of 50 dB.
...
1. Design a band-pass elliptic filter of order 4, IIR, with pass-band between 0.25 and 0.3 (or 2500 Hz to 3000 Hz for a sampling frequency of 5000Hz ), transition bands of width 0.02, a passband ripple of 0.5 dB and a minimum stop-band attenuation of 50 dB.
2. Plot the frequency response
3. Display the pole-zero plot
4. Plot the impulse response
